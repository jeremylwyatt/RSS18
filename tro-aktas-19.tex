...
% The paper headers
\markboth{Transactions on Robotics,~Vol.~100, No.~10, January~2019}%
...
\section{The Evaluative Models} \label{section:evaluative}
...
\bibliographystyle{IEEEtran}
\bibliography{newbib,main,deepgrasping,references,some_references_by_Chao}
