...
% The paper headers
\markboth{Robotics and Automation Letters}%
...
The authors gratefully acknowledge funding from the European Commission Funded project, PaCMan project FP7-IST-600918.
...
\bibliographystyle{IEEEtran}
\bibliography{total,newbib,main,deepgrasping,references,some_references_by_Chao}
