...
\caption{\textcolor{red}{A small selection of successful grasps by V11 (left) and V4 (right) on objects with highly novel shapes in comparison with the training grasps.} \label{fig:interest}}
\end{center}
\end{figure}
