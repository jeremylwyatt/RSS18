...
\begin{figure}
\centering
\includegraphics[width=0.6\columnwidth]{images/dominance}
...
\subfloat[GM1 Ranking Comparison]{%
  \includegraphics[width=0.6\columnwidth]{images/svr_gm1.pdf}
}

\subfloat[GM2 Ranking Comparison]{%
  \includegraphics[width=0.6\columnwidth]{images/svr_gm2.pdf}
}
